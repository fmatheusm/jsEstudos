...
var Pessoa = /*#__PURE__*/function () {
  ...
  return _createClass(Pessoa, [{
    key: "getNomeCompleto",
    value: function getNomeCompleto() {
...
// import * as meuModulo from './modulo1'; // importa tudo do modulo1 como um objeto
 // importa a função ou variável definida como padrão 
 // importa a classe Pessoa e as variáveis nome e sobrenome

// console.log(nome, sobrenome, idade);
// console.log(soma(5, 10));

var pessoa = new _pessoa__WEBPACK_IMPORTED_MODULE_1__["default"](_pessoa__WEBPACK_IMPORTED_MODULE_1__.nome, _pessoa__WEBPACK_IMPORTED_MODULE_1__.sobrenome); // cria uma nova instância da classe Pessoa
console.log(pessoa);
